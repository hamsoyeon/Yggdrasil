...
namespace test_client_unity
{
    public class LobbyMgr : Singleton<LobbyMgr>
    {
        ...
        private void Start()
        {
            ...
            enter_main_menu.onClick.AddListener(Click_MainMenuBtn);
        ...
        {
            GameObject.Find("lobby window").transform.Find("make room panel").gameObject.SetActive(true);
        }

        public void Click_MainMenuBtn()
        {
